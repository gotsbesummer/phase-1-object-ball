function gameObject() {
  ...
  function doesLongNameStealATon() {
    ...
    const playerStatsData = playerStats(longestName);
    
    const maxSteals = Math.max(
        ...Object.values(gameObject().home.players).map(p => p.steals),
        ...Object.values(gameObject().away.players).map(p => p.steals)
    );
  
    return playerStatsData && playerStatsData.steals === maxSteals;
  }
